...
class LostLeadsStatWidget extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        ...
        // Contar leads perdidos en el rango de fechas
        $count = $query->clone()
        ...
        // Para leads perdidos, el aumento es malo (danger) y la disminución es buena (success)
